...
from log_agent.agent import root_agent
...
initial_state = {
    ...
    "interaction_history": [],
    "init_message": """
    Okay, I'm ready to help you retrieve logs from Datadog. To get started, I need some information. 
...
async def main_async():
    ...
    print(new_session.state["init_message"])
